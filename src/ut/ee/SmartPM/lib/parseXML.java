...
public class parseXML extends AsyncTask<String, Void, Void> {
	...
	List<rulesObject<Double, Double, String>> locList = new ArrayList<rulesObject<Double, Double, String>>();

	public parseXML(List<rulesObject<Double, Double, String>> locList) {
	...
	protected Void doInBackground(String... params) {
		try {
            ...
            for (int i = 0; i < nodeList.getLength(); i++) {
    	    	...
    	    	locList.add(new rulesObject<Double, Double, String>(low, high, name));
